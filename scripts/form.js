...
let recoverytimeinmillis = document.getElementById("recoverytimeinmillis");
recoverytimeinmillis.addEventListener("change", changeSimParams());

let infectionprobability = document.getElementById("infectionprobability");
...
let vaccinationRange = document.getElementById("vaccination");
vaccinationRange.addEventListener("change", changeSimParams());

let effectivenessRange = document.getElementById("effectiveness");
